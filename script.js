...
function clearAllIntervals() {
  if (typeof chapter1Typing !== 'undefined') clearInterval(chapter1Typing);
  if (typeof chapter2Typing !== 'undefined') clearInterval(chapter2Typing);
  if (typeof chapter3Typing !== 'undefined') clearInterval(chapter3Typing);
  if (typeof birthdayTyping !== 'undefined') clearInterval(birthdayTyping);
}
...
function navigateTo(targetPageId) {
  ...
  if (targetPage) {
    ...
    if (targetPageId === "finalChapter" || targetPageId === "birthdayReveal" || targetPageId === "celebrationScene" || targetPageId === "ultimateEnding") {
...
function goBack() {
  ...
  if (prevPage) {
    ...
    if (previousPageId === "letterPage") startLetter();
    if (previousPageId === "chapter2") startChapter2();
    if (previousPageId === "chapter3") startChapter3();
    if (previousPageId === "birthdayReveal") openFinalSurprise();
  }
}
